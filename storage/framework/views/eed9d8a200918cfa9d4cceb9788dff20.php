<?php $__env->startSection('title', 'Manajemen Promo & Voucher'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
        ...
        <form action="<?php echo e(route('admin.promos.store')); ?>" method="POST" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
            <?php echo csrf_field(); ?>
            <div class="space-y-1">
                ...
                <tbody class="divide-y divide-slate-100 font-medium">
                    <?php $__empty_1 = true; $__currentLoopData = $promos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/80 transition">
                            <td class="p-4 font-mono font-black text-emerald-700 text-sm"><?php echo e($promo->code); ?></td>
                            <td class="p-4">
                                <div class="font-bold text-slate-900"><?php echo e($promo->title); ?></div>
                                <span class="px-2 py-0.5 bg-slate-100 rounded text-[10px] text-slate-600"><?php echo e($promo->badge ?? 'PROMO'); ?></span>
                            </td>
                            <td class="p-4 font-bold text-slate-900">
                                <?php if($promo->discount_type === 'percentage'): ?>
                                    <?php echo e($promo->discount_value); ?>% (Maks. Rp <?php echo e(number_format($promo->max_discount ?? 0, 0, ',', '.')); ?>)
                                <?php else: ?>
                            ...
                            <td class="p-4 text-slate-700">
                                <?php echo e($promo->used_count); ?> / <?php echo e($promo->usage_limit); ?> Digunakan
                            </td>
                            <td class="p-4 text-slate-700"><?php echo e($promo->valid_until->format('d M Y')); ?></td>
                            <td class="p-4">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookair/SevenInc/StayEase-Revisi/resources/views/dashboard/admin/promos.blade.php ENDPATH**/ ?>