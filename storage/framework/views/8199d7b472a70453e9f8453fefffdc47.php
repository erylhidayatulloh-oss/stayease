...
<div class="min-h-screen flex items-center justify-center px-4 py-10 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950">
    <div class="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl">
        ...
        <!-- Right: Login form -->
        <div class="bg-white p-8 sm:p-10" x-data="{ role: '<?php echo e($activeRole); ?>' }">
            ...
            <div class="mt-5 text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-xs font-bold text-slate-500 hover:text-slate-800">&larr; Kembali ke Situs Utama</a>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH /Users/macbookair/SevenInc/StayEase-Revisi/resources/views/auth/login.blade.php ENDPATH**/ ?>